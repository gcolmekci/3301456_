import 'package:flutter_app/hata.dart';
import 'package:flutter_app/mevlana.dart';
import 'package:flutter_app/sorular.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'Adınız ve Soyadınız:',
                style: GoogleFonts.roboto(
                    fontSize: 20.0, color: Colors.deepOrange[400]),
              ),
              Padding(
              ...
              Text(
                'Gökhan ÇÖLMEKÇİ',
                style: GoogleFonts.roboto(
                    fontSize: 10.0, color: Colors.deepOrange[400]),
              ),
            ],
          ),
        ),
