...
import 'package:flutter_app/bitir.dart';
...
class _SorularState extends State<Sorular> {
  ...
  var sorular = [
    ...
    {
      'soru':
          'Dünyanın en eski yerleşim yerlerinden biri olan ve UNESCO Dünya Miras Listesine alınan "Çatalhöyük" hangi ilçededir?',
    ...
    {
      'soru':
          "Konya sınırlarında yer alan Türkiye'nin ikinci büyük gölü ve en büyük tatlı su gölü hangisidir?",
      'cevaplar': ['Akşehir Gölü', 'Beyşehir Gölü', 'Tuz Gölü', 'Eğridir Gölü'],
      'dogrucevap': 'Beyşehir Gölü'
    },
    {
      'soru':
          'Konya da tarihi "Kral Yolu" üzerinde Kapadokya benzeri dokusu ile dikkati çeken antik kent hangisidir?',
      'cevaplar': [
        'Çatalhöyük',
        'Kubadabad Sarayı',
        'Selçuklu Köşkü',
    ...
    {
      'soru':
          "Hangisi Konya'da bulunan Selçuklu Dönemi tarihi eserlerinden değildir?",
      'cevaplar': [
        'Karatay Medresesi',
        'Sahibiata Külliyesi',
        'Sırçalı Medrese',
    ...
    {
      'soru':
          'Büyük Filozof ve mizah ustası Nasreddin Hoca nın "Dünyanın Ortası" olarak nitelendirdiği yer Konya ya bağlı hangi ilçede bulunmaktadır?',
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              'Bilgi Yarışması',
              style:
                  GoogleFonts.roboto(fontSize: 20.0, color: Colors.deepOrange[400]),
            ),
            Text('Ad-Soyad: ' + adSoyad, style: TextStyle(fontSize: 12.0)),
            Text('Öğrenci No: ' + ogrNo, style: TextStyle(fontSize: 12.0)),
            Text(
